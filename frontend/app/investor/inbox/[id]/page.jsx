...
export default async function InvestorInboxDetailPage({ params }) {
    ...
    return (
      <div className="max-w-3xl mx-auto mt-10">
        <div className="bg-red-50 text-red-600 p-6 rounded-xl text-center">
          <p>{error}</p>
          <BackButton href="/investor/inbox" label="Back to Inbox" className="mt-4" />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <BackButton href="/investor/inbox" label="Back to Inbox" />
      </div>

      <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
        <h1 className="text-2xl font-bold text-gray-900">
          {convo?.startup_name || "Founder Conversation"}
        </h1>
